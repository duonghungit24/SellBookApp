...
// @ts-ignore
export const SearchBookScreen: FC<StackScreenProps<NavigatorParamList, "searchBook">> = observer(function SearchBookScreen({navigation}) {
  ...
  return (
    <Screen style={ROOT} preset="fixed">
     <View style={WRAP_SEARCH}>  
        <TextField iconLeft placeholder="Tìm kiếm sách" style={{flex: 1, marginRight: 12}} />
